...
format:
  revealjs:
    theme: default
    slide-number: true
    logo: https://capsules-metho.github.io/diapos_analyse_r/img/capp.jpg
...
- Votre R est « pointe » toujours vers un dossier de votre ordinateur
...
**~/Dropbox/Conferences/FSS_2024/atelier_fss_2023_03_15/data/cleanCES2011_1.rds**
...
![](https://capsules-metho.github.io/diapos_analyse_r/img/df_in_env.png){.absolute top=300 left=150 width="70%"}
